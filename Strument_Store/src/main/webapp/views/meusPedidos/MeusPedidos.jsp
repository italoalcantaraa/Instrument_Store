...
<%@page import="br.com.model.ItemPedido"%>
...
<body>
	...
	<table>
		...
		<%
				PedidosList.pedidosList.add(new ItemPedido(1123,"https://http2.mlstatic.com/D_NQ_NP_2X_908282-MLU72574760628_112023-F.webp","Á caminho","Italo Ribeiro de Alcântara", 100));

								
								if(!PedidosList.pedidosList.isEmpty()){
							for(ItemPedido p : PedidosList.pedidosList) {
